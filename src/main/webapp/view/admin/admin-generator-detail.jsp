...
<head>
    ...
    <title>Chi tiet may phat dien — Warehouse OS</title>
...
<div class="app">
    ...
    <div>
        <header class="topbar">
            <h1>Chi tiet may phat dien</h1>
            <span class="crumb">/ <a href="${pageContext.request.contextPath}/admin/generators?action=list">May phat dien</a> / <span id="crumbId"><c:out value="${generator.model}"/></span></span>
        ...
        <main>
                ...
                <div class="hero-body">
                    <h2 class="hero-name">
                        ...
                        <c:if test="${generator.status == 'active'}">
                            <span class="verified"><svg viewBox="0 0 24 24"><path d="M20 6 9 17l-5-5"/></svg> Dang hoat dong</span>
                        </c:if>
                    </h2>
                    <div class="hero-meta">
                        ...
                        <span class="sep">·</span>
                        <span>Tao ngay <c:out value="${createdDate}"/></span>
                    </div>
                    <div class="hero-pills">
                        <span class="pill role-admin"><span class="pdot"></span><c:out value="${generator.powerRating}"/> kVA</span>
                        <c:choose>
                            <c:when test="${generator.status == 'active'}"><span class="pill status-active"><span class="pdot"></span>Dang hoat dong</span></c:when>
                            <c:when test="${generator.status == 'locked'}"><span class="pill status-active" style="color:var(--danger)"><span class="pdot"></span>Bi khoa</span></c:when>
                        </c:choose>
                    </div>
                </div>
            ...
            <div class="layout">
                <div class="toc">
                    <a class="toc-item active" data-toc="info"><span class="toc-num">01</span><span>Thong tin may</span></a>
                    <div class="toc-meta">
                        <strong>#<c:out value="${generator.id}"/></strong><br>
                        Tao: <c:out value="${createdDate}"/><br>
                        Cap nhat: <c:out value="${updatedDate}"/>
                    </div>
                </div>
                ...
                <div class="content">
                    <section class="section" id="info">
                        <div class="section-head">
                            <div>
                                <div class="section-num">01 — THONG TIN MAY PHAT DIEN</div>
                                <h3 class="section-title">Thong so ky thuat &amp; thong tin</h3>
                            </div>
                            <div class="section-update">Cap nhat <c:out value="${updatedDate}"/></div>
                        </div>
                        <div class="info-grid">
                            <div class="info-field">
                                <div class="info-label">Mau may</div>
                                <div class="info-value mono"><c:out value="${generator.model}"/></div>
                            </div>
                            <div class="info-field">
                                <div class="info-label">Thuong hieu</div>
                                <div class="info-value"><c:out value="${generator.brand}"/></div>
                            </div>
                            <div class="info-field">
                                <div class="info-label">Cong suat</div>
                                <div class="info-value mono"><c:out value="${generator.powerRating}"/> kVA</div>
                            </div>
                            <div class="info-field">
                                <div class="info-label">Don gia</div>
                                <div class="info-value mono"><fmt:formatNumber value="${generator.unitPrice}" pattern="#,###"/> VND</div>
                            </div>
                            <div class="info-field">
                                <div class="info-label">So luong ton kho</div>
