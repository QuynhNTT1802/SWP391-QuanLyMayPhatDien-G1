        ...
        <div class="app">
            ...
            <div>
                <header class="topbar">
                    ...
                    <span class="crumb">/ <a href="${pageContext.request.contextPath}/admin/generators?action=list">Máy phát điện</a> / <span><c:out value="${generator.model}"/></span></span>
                    ...
                    <div class="form-layout">
                        <form class="form-card" method="post" action="${pageContext.request.contextPath}/admin/generators?action=update">
                            ...
                            <div class="form-section" style="display:flex;gap:8px;justify-content:flex-end;">
                                <a class="btn" href="${pageContext.request.contextPath}/admin/generators?action=view&id=${generator.id}">Hủy</a>
