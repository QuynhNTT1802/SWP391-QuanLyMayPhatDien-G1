        ...
        <div class="app">
            ...
            <div>
                ...
                <main>
                    <div class="page-head">
                        <div class="left">
                            <div class="eyebrow">Quan tri · Super Admin</div>
                    ...
                    <form method="get" action="${pageContext.request.contextPath}/admin/generators" style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;flex:1;">
                        ...
                        <div class="search-input">
                            ...
                            <input name="search" value="<c:out value="${searchFilter}"/>" placeholder="Tim theo mau hoac thuong hieu..." autocomplete="off" />
                        </div>
                                            ...
                                            <tr onclick="if (!event.target.closest('button,a'))
                                                ...
                                                <td class="col-actions">
                                                    <div class="row-actions">
                                                        <button class="icon-mini" onclick="location.href = '${pageContext.request.contextPath}/admin/generators?action=view&id=${g.id}'" title="Xem chi tiet">
                                                            <svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                                        </button>
                                                        <button class="icon-mini" onclick="location.href = '${pageContext.request.contextPath}/admin/generators?action=update&id=${g.id}&page=${currentPage}'" title="Chinh sua">
