...
<body>
    <div class="app">
      ...
      <div class="page-head">
        ...
        <div class="page-sub">Tạo tài khoản mới hoặc gửi lời mời qua email. Người dùng sẽ nhận hướng dẫn kích hoạt trong vòng 5 phút.</div>
      </div>
        ...
        <form class="form-card" method="post" action="${pageContext.request.contextPath}/admin/users?action=create">
          <div class="form-section">
            <div class="form-section-head">
              ...
              <div class="form-section-desc">Họ tên hiển thị trên toàn bộ hệ thống. Email là thông tin đăng nhập, không thể đổi sau khi tạo.</div>
            </div>
            <div class="form-grid">
              <div class="field">
