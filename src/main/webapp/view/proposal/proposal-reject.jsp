...
<html lang="vi" data-theme="light">
    <head>
        ...
        <style>
            ...
            .page-head h1.title{font-size:26px;font-weight:700;letter-spacing:-0.02em;margin:0;display:flex;align-items:center;gap:10px;flex-wrap:wrap}
            ...
            .info-field .info-label{font-size:11px;color:var(--muted);font-weight:600;text-transform:uppercase;letter-spacing:0.02em;margin-bottom:4px}
            .info-field .info-value{font-size:14px;color:var(--fg);font-weight:600}
            .info-field .info-value.mono{font-family:var(--font-mono);font-weight:500}
            .info-field .info-value.empty{color:var(--muted);font-style:italic;font-weight:500}
            ...
            table.detail-table{width:100%;border-collapse:separate;border-spacing:0;font-size:13px}
            table.detail-table thead th{text-align:left;font-size:11px;color:var(--muted);text-transform:uppercase;font-weight:700;background:var(--surface-2);padding:10px 12px;border-bottom:1px solid var(--border);letter-spacing:0.04em}
            table.detail-table tbody td{padding:10px 12px;border-bottom:1px solid var(--border);vertical-align:middle}
            table.detail-table tbody tr:last-child td{border-bottom:0}
            .text-right{text-align:right}
            .text-center{text-align:center}
            .col-num{width:40px;text-align:center;color:var(--muted);font-weight:600}
