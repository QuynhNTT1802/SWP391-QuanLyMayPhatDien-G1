...
<title>500 — Lỗi máy chủ cục bộ | Warehouse OS</title>
...
<section class="error-section">
  <div class="error-content">
    ...
    <p class="error-desc">Máy chủ gặp sự cố khi xử lý yêu cầu của bạn. Quản trị viên đã được thông báo. Vui lòng thử lại sau hoặc quay về trang chủ.</p>
