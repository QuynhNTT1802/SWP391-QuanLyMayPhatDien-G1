...
<html lang="vi" data-theme="light">
    <head>
        ...
        <style>
            ...
            .col-qty { width: 100px; }
            .col-price { width: 130px; text-align: right; font-size: 13px; padding-top: 14px !important; }
            .col-del { width: 40px; text-align: center; }
            .row-unit-price { color: var(--muted); }
            .row-subtotal { color: var(--accent); font-weight: 600; }
            .row-del-btn {
            ...
            .grand-total-label { font-size: 13px; font-weight: 600; color: var(--muted); letter-spacing: 0.5px; }
            .grand-total-value { font-size: 20px; font-weight: 700; color: var(--accent); }
        </style>
    </head>
    <body>
        <div class="app">
