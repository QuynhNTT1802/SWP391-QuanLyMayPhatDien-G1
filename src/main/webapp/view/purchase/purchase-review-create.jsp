                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="submit" name="submitType" value="draft" class="btn" <c:if test="${not empty existingPo}">disabled</c:if>>Lưu nháp</button>
                                        <button type="submit" name="submitType" value="send" class="btn btn-primary" <c:if test="${not empty existingPo}">disabled</c:if>>Gửi CEO duyệt</button>
                                    </div>
                                </c:otherwise>
                            </c:choose>
                        </div>
