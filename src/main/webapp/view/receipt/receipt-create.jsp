                                    ...
                                    <div class="section-body">
                                        ...
                                        <c:if test="${not empty order}">
                                            <div class="field">
                                                ...
                                                <div style="padding:8px 10px;background:var(--accent-soft);border-radius:var(--radius-sm);">
                                                    <strong>${order.orderCode}</strong> — ${order.customerName}
                                                </div>
                                            </div>
                                        </c:if>
                                    </div>
                                ...
                                <div class="section detail-section">
                                    ...
                                    <div class="section-body">
                                        <table class="detail-table">
                                            ...
                                            <tbody id="detailBody">
                                                <c:choose>
                                                    <%-- Tạo TỪ ĐƠN: lặp qua từng dòng đã fill sẵn --%>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select name="generatorId" required>
                                                                        ...
                                                                        <c:forEach var="g" items="${generators}">
                                                                            <option value="${g.id}" <c:if test="${g.id == d.generatorId}">selected</c:if>>${g.model}${not empty brandMap[g.id] ? '
                                                                                             ('.concat(brandMap[g.id]).concat(')') : ''}</option>
                                                                            </c:forEach>
                                                                    </select>
                                                                </td>
                                                                ...
                                                                <td class="col-del">
                                                                    <button type="button" class="row-del-btn" onclick="removeRow(this)" title="Xoá dòng">
                                                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M8 6V4a2 2
                                                                                                                                                                                 0 0 1 2-2h4a2 2 0 0 1 2 2v2M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/></svg>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    </c:when>
                                                    <%-- Tạo THỦ CÔNG: 1 dòng trống như cũ --%>
                                                    <c:otherwise>
                                                        <tr>
                                                            ...
                                                            <td class="col-del">
                                                                <button type="button" class="row-del-btn" onclick="removeRow(this)" title="Xoá dòng">
                                                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M8 6V4a2 2 0 0
                                                                                                                                                                             1 2-2h4a2 2 0 0 1 2 2v2M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/></svg>
                                                                </button>
                                                            </td>
                                                        </tr>
                                                    </c:otherwise>
