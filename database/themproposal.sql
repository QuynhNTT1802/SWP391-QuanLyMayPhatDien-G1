...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Quản lý thông tin khách hàng';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `supplier` (
  ...
  KEY `fk_supplier_type_cat` (`customer_type_id`),
  ...
  CONSTRAINT `fk_supplier_type_cat` FOREIGN KEY (`customer_type_id`) REFERENCES `category` (`id`) ON DELETE SET NULL,
...
-- Dump completed on 2026-06-08 10:32:18
